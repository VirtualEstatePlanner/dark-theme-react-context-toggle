...
// Generate Sales Data
const createData: Function = (time: any, contestName: string, rating: number, rank: any) => {
  const dataObject = {
    time: time,
...
const getTier: Function = (rating: any) => {
...
export const Chart: Function = (): React.ReactElement => {
    ...
    <>
      ...
      <ResponsiveContainer>
        <LineChart
          ...
          <Line type='monotone' dataKey='rating' stroke={theme.palette.primary.main} />
        </LineChart>
      </ResponsiveContainer>
    </>
  )
